...
const Register = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <SEO
        title="Criar Conta | Canais18"
        description="Crie sua conta grátis no Canais18 e descubra os melhores grupos do Telegram."
      />
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-white/10 bg-card/60 backdrop-blur-xl p-8 shadow-2xl shadow-black/20">
          ...
          <p className="text-muted-foreground text-center text-sm mb-6">
            Junte-se à comunidade e descubra grupos incríveis
          </p>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center">
              <span className="bg-background/80 px-3 text-xs text-muted-foreground">ou cadastre-se com email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-sm font-medium text-foreground/80">Confirmar Senha</Label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                <Input
                  id="confirmPassword"
