    ...
    <div className="min-h-screen bg-[#0f0f0f] text-gray-200">
      ...
      <div className="bg-gradient-to-br from-[#1a1a1a] to-[#2d0a1a] border-b border-gray-800 py-14 px-4 text-center">
        <h1 className="text-3xl md:text-4xl font-black text-white mb-4">
          <span className="text-[#e91e63]">{keyword.charAt(0).toUpperCase() + keyword.slice(1)}</span>: Os Melhores Grupos do Telegram
        </h1>
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <ul className="flex flex-col gap-3 mb-12">
          {groups.map((g, i) => (
            ...
            >
              <span className="text-2xl font-black text-gray-700 w-8 text-center shrink-0">
                #{i + 1}
              </span>
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-2">
                  ...
                  <span className="text-xs text-gray-600">
                    👥 {g.member_count.toLocaleString("pt-BR")} membros
                  </span>
                </div>
              </div>
              <a
        ...
        <div className="bg-gradient-to-r from-[#e91e63] to-[#880e4f] rounded-xl p-8 text-center mb-12">
          <h2 className="text-white text-xl font-black mb-2">
            Mais de 1.902 grupos esperando por você
          </h2>
